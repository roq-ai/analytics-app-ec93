...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order.update': { roles: ['owner'], key: 'order-status-update', tenantPath: ['business', 'order'], userPath: [] },
  'product.create': { roles: ['owner'], key: 'new-product-added', tenantPath: ['business', 'product'], userPath: [] },
  'customer.update': {
    roles: ['owner'],
    key: 'customer-details-update',
    tenantPath: ['business', 'customer'],
    userPath: [],
  },
};

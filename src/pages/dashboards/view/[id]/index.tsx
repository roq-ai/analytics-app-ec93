        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Current Day Sales" text={data?.current_day_sales} />

                <FormListItem label="Week To Date Sales" text={data?.week_to_date_sales} />

                <FormListItem label="Average Order Amount" text={data?.average_order_amount} />

                <FormListItem label="Total Orders" text={data?.total_orders} />

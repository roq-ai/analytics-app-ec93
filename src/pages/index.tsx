  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Analytics App - Your secure gateway to insightful sales data. Discover trends, track your performance and make data-driven decisions with ease."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1551288049-bebda4e38f71?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkYXNoYm9hcmR8ZW58MHx8fHwxNjk0NzY2ODMyfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Analytics App - Your secure gateway to insightful sales data. Discover trends, track your performance and make data-driven decisions with ease.`}
            </Text>
            <Box
